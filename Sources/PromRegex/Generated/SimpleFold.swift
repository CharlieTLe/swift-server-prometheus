...
//
// Mirrors Go's unicode.SimpleFold. Only runes with a non-identity orbit are
// listed; everything else folds to itself.
//===----------------------------------------------------------------------===//

extension UnicodeTables {
    /// (rune, next-in-fold-orbit) sorted by rune. 2878 entries.
    static let simpleFoldPairs: [(from: UInt32, to: UInt32)] = [
