...
Green as of this commit: **339,920 committed fixture lines, 683 tests** across 24 test targets, on both
...
**32 of 47**, with every survivor's argument written into the source or the sweep's tail, next to the code it
concerns.
